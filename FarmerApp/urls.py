...
urlpatterns=[
    ...
    #path('farmer/shop/<str:model>/<int:sc_id>', views.farm_product_detail, name='farmer_product_detail'),
    #path('farmer/cart',views.farm_cart_detail,name='farmer_cart_detail'),
    #path('farmer/cart/add/<str:model>/<int:product_id>',views.farm_cart_add,name='farmer_cart_add'),
    #path('farmer/cart/remove/<str:model>/<int:pid>',views.farm_cart_remove,name='farmer_cart_remove'),
